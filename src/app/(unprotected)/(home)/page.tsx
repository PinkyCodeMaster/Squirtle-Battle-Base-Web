import { ShoppingBag, MapPin, FileText, Shield, Star, Users, Target, ArrowRight } from 'lucide-react'
...
export default function HomePage() {
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-8 text-center text-foreground">Why Choose Squirtle Battle Base?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: ShoppingBag, title: "Buy/Sell Gear", description: "Peer-to-peer marketplace for tactical and airsoft equipment." },
              { icon: MapPin, title: "Explore Game Sites", description: "Find and review airsoft game sites in the UK." },
              { icon: Star, title: "User Reviews", description: "Read and submit reviews on gear, shops, and sites." },
              { icon: Shield, title: "Secure Payments", description: "Protected transactions with Stripe." },
            ].map((benefit, index) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="#" className="hover:text-primary">Game Sites Map</Link></li>
                <li><Link href="#" className="hover:text-primary">Blogs & Reviews</Link></li>
